...
Начал увлекаться программированием в 2016 году: в старшей школе познакомился с языком Pascal. Сейчас работаю на позиции `JavaScript Backend разработчика` в Tages: разрабатываю и поддерживаю REST-методы. Также увлекаюсь UI: люблю делать макеты для своих проектов в Figma. Сейчас учу `React` and `NodeJS`.
