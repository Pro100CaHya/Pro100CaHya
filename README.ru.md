...
Начал увлекаться программированием в 2016 году: в старшей школе познакомился с языком Pascal. Сейчас работаю на позиции `Младший JavaScript разработчик` в [Carely.group](https://carely.group): разрабатываю и поддерживаю скрипты парсинга. Также люблю UI: люблю делать макеты для своих проектов в Figma. Сейчас учу `React` and `NodeJS`.
